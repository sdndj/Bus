...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap map) {
        ...
        double latitude = gps.getLatitude();    //위도,경도를 저장
        double longitude = gps.getLongitude();

        LatLng myPosition = new LatLng(latitude, longitude); //자신의 위치를 저장
        map.moveCamera(CameraUpdateFactory.newLatLng(myPosition)); //맵 시작 시 myPosition으로 카메라 이동
        ...
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            map.setMyLocationEnabled(true); //자기 위치로 이동하는 버튼 활성화
        }
    }
    /**
